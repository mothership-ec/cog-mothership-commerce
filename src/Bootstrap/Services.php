...
class Services implements ServicesInterface
{
	public function registerServices($services)
	{
		...
		$services['stock.notification.replenished.loader'] = function($c) {
		...
		$services['stock.notification.replenished.create'] = function($c) {
			return new Commerce\Product\Stock\Notification\Replenished\Create($c['db.query']);
		};

		$services['stock.notification.replenished.edit'] = function($c) {
	...
	public function registerEmails($services)
	{
		 ...
		 */
		$services['mail.factory.stock.notification.replenished'] = $services->factory(function($c) {
			$factory = new \Message\Cog\Mail\Factory($c['mail.message']);
